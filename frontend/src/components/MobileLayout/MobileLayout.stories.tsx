...
export const Documentation: StoryObj = {
  render: () => (
    <div style={{ padding: 32, color: '#94a3b8', fontFamily: 'system-ui', maxWidth: 560 }}>
      <h2 style={{ color: '#f1f5f9', marginBottom: 12 }}>MobileLayout</h2>
      <p>This is a full-page authenticated layout component. It requires Next.js navigation and localStorage auth context.</p>
      <p style={{ marginTop: 12 }}>To preview: open the app on a mobile viewport (≤768 px) while authenticated.</p>
