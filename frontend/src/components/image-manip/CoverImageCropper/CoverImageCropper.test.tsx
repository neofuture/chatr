...
const defaultProps = {
  imageFile: new File(['pixels'], 'cover.png', { type: 'image/png' }),
...
describe('CoverImageCropper', () => {
  it('renders overlay', () => {
    const { container } = render(<CoverImageCropper {...defaultProps} />);
    expect(container.firstChild).toBeInTheDocument();
  });

  it('shows title "Adjust Your Cover Image"', () => {
    render(<CoverImageCropper {...defaultProps} />);
    expect(screen.getByText('Adjust Your Cover Image')).toBeInTheDocument();
  });
